...
function crearCard(nombre, precio, url, id) {
    ...
    prodcuto.className = "card";
    prodcuto.innerHTML = `
    <div class="card-fondo">
        <img class="producto-imagen" src="${url}" alt="${nombre}" srcset="">
        <span class="producto-descripcion">${nombre}</span>
        <div class="contenedor-precios">
            <span class="producto-precio">$${precio}</span>
            <button class="boton-eliminar" id="${id}" data-eliminar>
    ...
    const botonBorrar = prodcuto.querySelector("[data-eliminar]");
